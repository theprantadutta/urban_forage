...
export const FoodListingCard: React.FC<FoodListingCardProps> = ({
  ...
  const { isScreenReaderEnabled, announceMessage, isReduceMotionEnabled } =
    useAccessibility();
      ...
      >
        ...
        <View className="p-4">
          ...
          <View className="flex-row items-start justify-between mb-2">
            <Text
              className="text-gray-900 text-lg font-bold flex-1 mr-2"
              numberOfLines={2}
            >
              {listing.title}
            </Text>
            ...
            <View className="flex-row items-center flex-1">
              ...
              <View className="flex-1">
                <View className="flex-row items-center">
                  <Text
                    className="text-gray-900 text-sm font-medium mr-2"
                    numberOfLines={1}
                  >
                    {listing.provider}
                  </Text>
